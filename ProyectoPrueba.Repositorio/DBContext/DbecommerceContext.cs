...
namespace ProyectoPrueba.Repositorio.DBContext;
...
public partial class DbecommerceContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__A3C02A1072C3F15C");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__AAA5CEC2ACFB5A03");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__09889210E2E569E1");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF97D4A1E865");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__BC1240BD4223CA6E");
